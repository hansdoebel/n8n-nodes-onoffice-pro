		...
		options: [
			{
				...
				name: 'datestart',
				description: 'Start date of the time interval for the requested appointments',
				type: 'dateTime',
				default: '',
			},
			{
				...
				name: 'dateend',
				description: 'End date of the time interval for the requested appointments',
				type: 'dateTime',
				default: '',
			},
			{
				...
				name: 'von',
				description: 'The user to be entered as the appointment creator at field “von” (creator)',
				type: 'string',
				default: '',
			},
			{
			...
			},
			{
				...
				name: 'abgesagt',
				description: 'Whether appointment status on active or cancelled. Default: false.',
				type: 'boolean',
				default: false,
			},
			{
